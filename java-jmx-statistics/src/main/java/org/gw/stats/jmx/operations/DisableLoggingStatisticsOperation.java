 ...
 * @since 1.0
 */
public class DisableLoggingStatisticsOperation extends StatisticOperation<Statistic> {

    public DisableLoggingStatisticsOperation() {
        namePrefix = "Disable Logging: ";
    }
